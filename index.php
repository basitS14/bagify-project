 ...
 <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#watch"> <img src="images/backpack_cover.jpg" class="img-fluid1" alt="" >
            ...
            <div class="col-6 col-md-3 py-3 " >
                <a href="products.php#shirt"  >
                  <img src="images/tote_cover.jpg" class="img-fluid1" alt=""  >
                     <div class="h5 pt-3 font-weight-bolder">
                        Tote Bags
                     </div>
                  </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#shoes">
                 <img src="images/handbag_cover.jpg" class="img-fluid1" alt="" >
                <div class="h5 pt-3 font-weight-bolder">
                    Handbags
                 </div>
             </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#headphones">
                 <img src="images/slingbags_cover.jpg" class="img-fluid1" alt=""  >
                 <div class="h5 pt-3 font-weight-bolder">
                    Sling Bags
                 </div>
              </div>
