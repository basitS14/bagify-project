...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Bagify</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#backpacks" class="dropdown-item">Backpacks</a>
                                   <a href="products.php#totebags" class="dropdown-item">Totebags</a>
                                   <a href="products.php#handbags" class="dropdown-item">Handbags</a>
                                   <a href="products.php#slingbags" class="dropdown-item">Sling Bags</a>
                               </div>
